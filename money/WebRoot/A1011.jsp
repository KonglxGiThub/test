...
<br>
<br>
<form action="/money/a1011" method="post">
  <TABLE border="1" align="center" width="45%">
    ...
    <TR>
      <TD>摘要</TD>
      <TD>
        <input type="text" name="aab002" value="${param.aab002 }">
      </TD>
    </TR>
    <TR>
      <TD>金额</TD>
      <TD>
        <input type="number" name="aab003" step="0.01"  value="${param.aab003 }">
      </TD>
    </TR>
    <TR>
      <TD>类别</TD>
      <TD>
        <select name="aab004" style="width:153px">
          <c:forEach var="ins" items="${ocaab004 }">
            <option ${param.aab004==ins.code?'selected':'' } value="${ins.code }">
              ${ins.label }
            </option>
          </c:forEach>
        </select>
    ...
    <TR>
      <TD>日期</TD>
      <TD>
        <input type="date" name="aab005"  value="${param.aab005 }">
      </TD>
    </TR>
    <TR>
      <TD>备注</TD>
      <TD>
        <textarea rows="5" cols="45" name="aab007">${param.aab007 }</textarea>
      </TD>
    </TR>
    <TR>
