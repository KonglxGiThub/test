...
public class ViewSekerById2 extends HttpServlet{
	private static final long serialVersionUID = 1L;
	private ResDao dao;
	public ViewSekerById2(){
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			rb = dao.findSeeker(id);
			request.setAttribute("ResumeBean", rb);
			request.getRequestDispatcher("Seeker2.jsp").forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
		}
