...
(function(global,doc){
    ...
    function checkModule(moduleName){
        ...
        if(cache[moduleType.count + moduleName] > waitCount){
            debug('鎵句笉鍒版ā鍧楀悕鎴栬€呭姞杞借秴鏃�:' + moduleName, 'error');
...
define('base.class', 'base.util', function(require, exports){
    ...
    Class.extend = function(o){
        if(!checkContext(this))
            throw new Error('class.extends: 绫诲璞＄殑绫诲瀷涓嶇鍚�');
        return util.extend(this, o);
    }
    Class.implement = function(items){
        if(!checkContext(this))
            throw new Error('class.implement: 绫诲璞＄殑绫诲瀷涓嶇鍚�');
    ...
    Class.parent = function(method){
        if( !checkContext(this) )
            throw new Error('class.parent: 绫诲璞＄殑绫诲瀷涓嶇鍚�');
        if( !this.superclass )
            throw new Error('class.parent: 鎵句笉鍒扮埗绫�');
...
define('base.shape', [
    ...
    return function(o){
        if(!util.type.isFunction(o) && !util.type.isObject(o)){
            throw new Error('base.shape: 绫诲瀷涓嶇鍚�');
        }
...
define('base.aspect', function(require, exports){
    ...
    function aop(status, methodName, callback){
        ...
        while(name = names.shift()){
            method = this[name];
            if(!method){
                throw new Error('base.aspect: 鏃犳晥鏂规硶[' + methodName + ']');
            }
            if(!method._isAop){
                wrap.call(this, name);
            }
...
define('tools.cookie', function(require, exports){
    ...
    function checkCookieName(name){
        if(util.type.isEmptyString(name)){
            throw new Error('base.cookie: 蹇呴』鎸囧畾cookie鍚嶇О');
        }
    }
