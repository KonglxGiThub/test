...
function top(){
   	form3.action="<%=basePath%><%=dir %>/hui/index.jsp?page=1";
    form3.submit();
}
function last(){
	...
	form3.action="<%=basePath%><%=dir %>/hui/index.jsp?page="+form3.pageCount.value;
    	form3.submit();
	}
}
function pre(){
  ...
  if(page<=1){
    ...
    form3.action="<%=basePath%><%=dir %>/hui/index.jsp?page="+(page-1);
    form3.submit();
  }
}
...
function bjump(){
	...
	if(form3.busjump.value>pageCount){//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
	  ...
	  form3.submit();
		...
		form3.action="<%=basePath%><%=dir %>/hui/index.jsp?page="+pageCount;
		form3.submit();
	}
}
...
var page=parseInt(form3.busjump.value);
   if(page==0){
      ...
      form3.action="<%=basePath%><%=dir %>/hui/index.jsp?page="+page;
      form3.submit();
   }else{
      form3.action="<%=basePath%><%=dir %>/hui/index.jsp?page="+page;
      form3.submit();
...
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
     <tr class="head"> 
      ...
      <td  align="center">回访信息名称</td>
      <td  align="center">回访单位</td>
      <td  align="center">回访日期</td>
      <td  align="center">回访原因</td>
	...
	<tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'"> 
      ...
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath+dir+"/" %>hui/add.jsp?method=upHf&id=<%=pagelist2.get(0).toString()%>" >查看/修改</a> </td>
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath%>DepServlet?method=delHf&id=<%=pagelist2.get(0).toString()%>" >删除</a></td>
    </tr>
...
%>  
	...
	<TABLE width="100%" border=0 align="right" cellPadding=0 cellSpacing=0>
	 ...
	 <a href="<%=basePath %>admin/hui/add.jsp?method=addHf"><font color=red>增加回访信息</font></a>	
