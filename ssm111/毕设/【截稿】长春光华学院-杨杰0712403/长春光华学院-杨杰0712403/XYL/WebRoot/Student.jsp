...
<html>
	  ...
	  <!-- 主题 Css文件 -->
	  <link id="easyuiTheme" rel="stylesheet" href="themes/sunny/easyui.css" type="text/css"></link>
	  <style type="text/css">
	  ...
	  $('#Earea').tree({
		  	...
		  	data:[{
                   ...
                   id:4,
		  		   ...
		  		   iconCls:'man-ok2',
		  		   attributes : {
                        url :'pages/stuPage/StuUsers.jsp',
                    }
		  		   }],
		  			},{
		  		   id:2,
                   ...
                   id:9,
		  		   ...
		  		   iconCls:'man-ok2',
		  		   attributes : {
                        url :'pages/stuPage/StuMessage.jsp',
                    }
		  		   }],
		  			}],
	...
	<body class="easyui-layout" style="height:100%">
   		<div data-options="region:'north'" style="height:90px;width:100%;" >
			...
			<div class="quit">
				<a id="btn" href="login.jsp" target="_self"  class="easyui-linkbutton" data-options="plain:true,text:'  退出登录'">&nbsp;&nbsp;退出登录</a>
			</div>
			</div>
		<!-- 底部版权信息 -->
