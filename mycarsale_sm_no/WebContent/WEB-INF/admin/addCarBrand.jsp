...
<script type="text/javascript" src="<%=path %>/js/menu.js"></script> 
	...
	<body>
		<form name="form1" method="post" action="<%=path %>/brand/CarBrandAddSubmit.action">
			<table width="300" border="0" align="center" cellpadding="4"
				...
				<tr>
					...
					<td width="204" height="24" bgcolor="#FFFFFF">
						<input name="brandName" type="text" id="brandName" class="input1">
				...
				<tr>
					...
					<td height="24" bgcolor="#FFFFFF">
						<input type="text" name="brandDes" id="brandDes"
							class="input1">
					</td>
				</tr>
						<tr>
					...
					<td height="24" bgcolor="#FFFFFF">
						<input  type="text" name="brandOder" id="brandOder"
							class="input1">
					</td>
				</tr>
