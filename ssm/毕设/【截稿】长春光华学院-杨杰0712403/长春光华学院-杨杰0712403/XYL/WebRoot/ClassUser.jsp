...
<html>
	  ...
	  <style type="text/css">
			...
			.welcome{ text-align:right;position:relative;margin-top:0px;padding-right:20px;top:30px;left:-150px; }
	  ...
	  $('#Earea').tree({
		  	...
		  	data:[{
                   ...
                   id:4,
		  		   ...
		  		   iconCls:'man-ok2',
		  		   attributes : {
                        url :'pages/classPage/StuUsers.jsp',
                    }
		  		   },{
                   id:5,
		  		   text: '个人管理',
		  		   iconCls:'man-ok2',
		  		   attributes : {
                        url :'pages/classPage/ClsUsers.jsp',
                    }
		  		   }],
		  			},{
		  		   id:2,
                   ...
                   id:6,
		  		   ...
		  		   iconCls:'man-ok2',
		  		   attributes : {
                        url :'pages/classPage/ClsNews.jsp',
                    }
		  		   },{
                   id:7,
		  		   text: '班级留言板管理',
		  		   iconCls:'man-ok2',
		  		   attributes : {
                        url :'pages/classPage/ClsMessage.jsp',
                    }
		  		   }]
		  			}],
