	...
	<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0'>
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      ...
	      <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items2_1")'><b>音乐分类管理</b></dt>
	        <dd style='display:block' class='sitem' id='items2_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/catelogMana.action' target='main'>音乐分类</a> </li>
	            <li><a href='<%=path %>/yinyueMana.action' target='main'>音乐管理</a> </li>
	            <li><a href='<%=path %>/admin/yinyue/yinyueAdd.jsp' target='main'>音乐添加</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
	      ...
	      <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items3_1")'><b>会员留言板</b></dt>
	        <dd style='display:block' class='sitem' id='items3_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/liuyanMana.action' target='main'>留言板管理</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
