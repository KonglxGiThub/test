...
<div class="bread">
<a href="/ZPWZ/">首页</a>&gt;<a>职位</a>&gt;<a href='/ZPWZ/FindAllSeker' >招聘者信息</a>
</div>
<div class="newJobBg">
<div class="newJobLf">
<div class="newJobtop">
...
<ul class="newtopLit" style="position:relative;left:-35px"><li>性别：</li>
<% if(rb.getSek().getSex().equals("1")){%>
	男
<% }else{%>
	女
<% }%>
...
<a href="downLoadServlet?filename=<%=rb.getSek().getFile() %>">查看求职者简历</a><img style="margin-left:8px;" src="images/newjob_59.png" width="11" height="10" />
</div></div>
<div class="nrtTopLit">
<ul class="nrtLit">
