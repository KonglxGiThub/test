...
function top(){
   	form3.action="<%=basePath%><%=dir %>/emp/index.jsp?page=1";
    form3.submit();
}
function last(){
	...
	form3.action="<%=basePath%><%=dir %>/emp/index.jsp?page="+form3.pageCount.value;
    	form3.submit();
	}
}
function pre(){
  ...
  if(page<=1){
    ...
    form3.action="<%=basePath%><%=dir %>/emp/index.jsp?page="+(page-1);
    form3.submit();
  }
}
...
function bjump(){
	...
	if(form3.busjump.value>pageCount){//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
	  ...
	  form3.submit();
		...
		form3.action="<%=basePath%><%=dir %>/emp/index.jsp?page="+pageCount;
		form3.submit();
	}
}
...
var page=parseInt(form3.busjump.value);
   if(page==0){
      ...
      form3.action="<%=basePath%><%=dir %>/emp/index.jsp?page="+page;
      form3.submit();
   }else{
      form3.action="<%=basePath%><%=dir %>/emp/index.jsp?page="+page;
      form3.submit();
...
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
     <tr class="head"> 
      ...
      <td  align="center">售后服务名称</td>
      <td  align="center">售后服务单位</td>
      <td  align="center">售后服务日期</td>
      <td  align="center">售后服务类型</td>
      <td  align="center">对方联系人</td>
	...
	<tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'"> 
      ...
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><%=pagelist2.get(9).toString().substring(0,10) %></td>
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath+dir+"/" %>emp/add.jsp?method=upEmp&id=<%=pagelist2.get(0).toString()%>" >修改</a> </td>
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath%>DepServlet?method=delEmp&id=<%=pagelist2.get(0).toString()%>" >删除</a></td>
    </tr>
...
%>  
	...
	<TABLE width="100%" border=0 align="right" cellPadding=0 cellSpacing=0>
	 ...
	 <a href="<%=basePath %>admin/emp/add.jsp?method=addEmp"><font color=red>增加售后服务信息</font></a>	
