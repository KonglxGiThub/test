...
function top(){
   	form3.action="<%=basePath%><%=dir %>/pay/index.jsp?page=1";
    form3.submit();
}
function last(){
	...
	form3.action="<%=basePath%><%=dir %>/pay/index.jsp?page="+form3.pageCount.value;
    	form3.submit();
	}
}
function pre(){
  ...
  if(page<=1){
    ...
    form3.action="<%=basePath%><%=dir %>/pay/index.jsp?page="+(page-1);
    form3.submit();
  }
}
...
function bjump(){
	...
	if(form3.busjump.value>pageCount){//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
	  ...
	  form3.submit();
		...
		form3.action="<%=basePath%><%=dir %>/pay/index.jsp?page="+pageCount;
		form3.submit();
	}
}
...
var page=parseInt(form3.busjump.value);
   if(page==0){
      ...
      form3.action="<%=basePath%><%=dir %>/pay/index.jsp?page="+page;
      form3.submit();
   }else{
      form3.action="<%=basePath%><%=dir %>/pay/index.jsp?page="+page;
      form3.submit();
...
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
     <tr class="head"> 
      ...
      <td  align="center">维修服务名称</td>
      <td  align="center">维修服务单位</td>
      <td  align="center">维修服务日期</td>
      <td  align="center">维修服务内容</td>
      <td  align="center">维修金额</td>
    ...
    <% 
			...
			int cou = eb.getMessageCountWx();//得到信息总数			        
			...
			List pagelist1 = eb.getMessageWx(Integer.parseInt(page1));
	...
	<tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'"> 
      ...
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><%=pagelist2.get(7).toString().substring(0,10) %></td>
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath+dir+"/" %>pay/add.jsp?method=upWx&id=<%=pagelist2.get(0).toString()%>" >查看/修改</a> </td>
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath%>DepServlet?method=delWx&id=<%=pagelist2.get(0).toString()%>" >删除</a></td>
    </tr>
...
%>  
	...
	<TABLE width="100%" border=0 align="right" cellPadding=0 cellSpacing=0>
	 ...
	 <a href="<%=basePath %>admin/pay/add.jsp?method=addWx"><font color=red>增加产品维修信息</font></a>	
