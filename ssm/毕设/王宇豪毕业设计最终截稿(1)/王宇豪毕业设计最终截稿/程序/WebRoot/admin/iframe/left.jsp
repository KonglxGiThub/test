...
<TABLE  bgColor=#eef8fe cellSpacing=0 cellPadding=0 width="90%" align=center border=0>
  ...
  <TABLE width="100%" border="0" align="center"style="cursor:hand" onclick=javascript:expand(1)>
    ...
    <a href="<%=basePath %><%=dir %>/system/user.jsp" target="MainFrame">管理员设置</a></TD></TR>
    </TABLE>
  </TD>
  </TR>
  ...
  <TR>
  	<TD height="31" background="<%=basePath %><%=dir %>/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %><%=dir %>/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %><%=dir %>/images/menu.gif" align=absMiddle>
    <a href="<%=basePath %><%=dir %>/dep/index.jsp" target="MainFrame">售后服务分类</a></TD></TR>
  </TABLE>
  </TD>
  </TR>
  <TR ParentID="SystemLastArticle" AllParentID="SystemLastArticle">
  ...
  <TR>
  	<TD height="31" background="<%=basePath %><%=dir %>/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %><%=dir %>/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %><%=dir %>/images/menu.gif" align=absMiddle>
    <a href="<%=basePath %><%=dir %>/emp/index.jsp" target="MainFrame">售后服务信息</a></TD></TR>
  </TABLE>
  </TD>
  </TR>
  <TR ParentID="SystemLastArticle" AllParentID="SystemLastArticle">
  ...
  <TR>
  	<TD height="31" background="<%=basePath %><%=dir %>/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %><%=dir %>/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %><%=dir %>/images/menu.gif" align=absMiddle>
    <a href="<%=basePath %><%=dir %>/emp/s.jsp" target="MainFrame">售后服务查询</a></TD></TR>
  </TABLE>
  </TD>
  </TR>
  <TR ParentID="SystemLastArticle" AllParentID="SystemLastArticle">
  ...
  <TR>
  	<TD height="31" background="<%=basePath %><%=dir %>/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %><%=dir %>/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %><%=dir %>/images/menu.gif" align=absMiddle>
    <a href="<%=basePath %><%=dir %>/attend/index.jsp" target="MainFrame">产品安装信息</a></TD></TR>
  </TABLE>
  </TD>
  </TR>
  <TR ParentID="SystemLastArticle" AllParentID="SystemLastArticle">
  ...
  <TR>
  	<TD height="31" background="<%=basePath %><%=dir %>/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %><%=dir %>/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %><%=dir %>/images/menu.gif" align=absMiddle>
    <a href="<%=basePath %><%=dir %>/attend/s.jsp" target="MainFrame">安装信息查询</a></TD></TR>
  </TABLE>
  </TD>
  </TR>
  <TR ParentID="SystemLastArticle" AllParentID="SystemLastArticle">
  ...
  <TR>
    <TD height="31" background="<%=basePath %><%=dir %>/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %><%=dir %>/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %><%=dir %>/images/menu.gif" align=absMiddle>
    <a href="<%=basePath %><%=dir %>/pay/index.jsp" target="MainFrame">产品维修信息</a></TD></TR>
  </TABLE>
  </TD>
  </TR>
  ...
  <TR>
    <TD height="31" background="<%=basePath %><%=dir %>/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %><%=dir %>/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %><%=dir %>/images/menu.gif" align=absMiddle>
    <a href="<%=basePath %><%=dir %>/pay/s.jsp" target="MainFrame">维修信息查询</a></TD></TR>
  </TABLE>
  </TD>
  </TR>
   <TR ParentID="SystemLastArticle" AllParentID="SystemLastArticle">
  ...
  <TR>
    <TD height="31" background="<%=basePath %><%=dir %>/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %><%=dir %>/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %><%=dir %>/images/menu.gif" align=absMiddle>
    <a href="<%=basePath %><%=dir %>/tui/index.jsp" target="MainFrame">产品退换信息</a></TD></TR>
  </TABLE>
  </TD>
  </TR>
   <TR ParentID="SystemLastArticle" AllParentID="SystemLastArticle">
  ...
  <TR>
    <TD height="31" background="<%=basePath %><%=dir %>/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %><%=dir %>/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %><%=dir %>/images/menu.gif" align=absMiddle>
    <a href="<%=basePath %><%=dir %>/tui/s.jsp" target="MainFrame">退换信息查询</a></TD></TR>
  </TABLE>
  </TD>
  </TR>
   <TR ParentID="SystemLastArticle" AllParentID="SystemLastArticle">
  ...
  <TR>
    <TD height="31" background="<%=basePath %><%=dir %>/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %><%=dir %>/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %><%=dir %>/images/menu.gif" align=absMiddle>
    <a href="<%=basePath %><%=dir %>/hui/index.jsp" target="MainFrame">产品回访信息</a></TD></TR>
  </TABLE>
  </TD>
  </TR>
   <TR ParentID="SystemLastArticle" AllParentID="SystemLastArticle">
  ...
  <TR>
    <TD height="31" background="<%=basePath %><%=dir %>/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %><%=dir %>/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %><%=dir %>/images/menu.gif" align=absMiddle>
    <a href="<%=basePath %><%=dir %>/hui/s.jsp" target="MainFrame">回访信息查询</a></TD></TR>
  </TABLE>
  </TD>
  </TR>
    <TR ParentID="SystemLastArticle" AllParentID="SystemLastArticle">
  ...
  <TR>
    <TD height="31" background="<%=basePath %><%=dir %>/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %><%=dir %>/images/linkbg1.gif" >&nbsp;<IMG src="<%=basePath %><%=dir %>/images/menu.gif" align=absMiddle>
    <a href="<%=basePath %><%=dir %>/guestbook/index.jsp" target="MainFrame">投诉信息管理</a></TD></TR>
  </TABLE>
  </TD>
  </TR>
   </TBODY>
